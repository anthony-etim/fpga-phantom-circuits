...
print('Building async_fifo design for board ' + board + '...')

# Set other parameters
build_dir = '' + '../build/' + board + ''
src = '' + build_dir + '/source.txt'
toplevel = 'async_fifo_loopback'
...
cmd = "sed -ie 's/parameter CLK_SPEED     = 300_000_000,/parameter CLK_SPEED     = %d,/g' %s"%(int(input_clk_freq_mhz)*1000000, build_dir + '/src/async_fifo_loopback.v')
