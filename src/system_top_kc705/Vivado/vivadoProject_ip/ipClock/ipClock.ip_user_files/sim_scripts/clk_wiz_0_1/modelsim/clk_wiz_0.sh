...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/shanquan/git/fpga-phantom-circuits/src/ro_crosstalk_phantum_sameLongWire/Vivado/vivadoProject_ip/ipClock/ipClock.cache/compile_simlib/modelsim"
  fi
