...
def phantom_heater_measure(usb_port, baud, delay_cycles, tx_delayTime, cooldown_cycles, num_tx_bits, roCounts, tx, tx_bits_ref, plot_path, ro_sensor_cycles, ro_sensor_cycles_offset, ro_heater_on_num):
    ...
    print ("Number of RO Heaters on \t:", debug)
    time.sleep(0.1)
...
if __name__ == "__main__":
    ...
    ro_heater_on_num = 5
    data_path ='/home/anthony/Documents/fpga-phantom-circuits/src/system_top/experiments/phantom_ro_heater/data/'
    plot_path ='/home/anthony/Documents/fpga-phantom-circuits/src/system_top/experiments/phantom_ro_heater/plots/'
    ro_counts_path = '/home/anthony/Documents/fpga-phantom-circuits/src/system_top_kc705/experiments/phantom_ro_counts/data/'
    error_rate_path = '/home/anthony/Documents/fpga-phantom-circuits/src/system_top/experiments/error_rates/'

    i = 0
    while i < num_measurements: 
        phantom_heater_measure(usb_port, args.baud, delay_cycles= delay_cycles, tx_delayTime= int((2**24)*10), cooldown_cycles= cooldown_cycles, num_tx_bits= num_tx_bits, roCounts=roCounts, tx=tx,tx_bits_ref=tx_bits_ref,plot_path=plot_path,ro_sensor_cycles=ro_sensor_cycles, ro_sensor_cycles_offset=ro_sensor_cycles_offset, ro_heater_on_num=ro_heater_on_num)
        i = i + 1
    ...
    # analysis(ro_counts_path + saveFile,num_measurements,tx,tx_bits_ref,num_tx_bits,cooldown_cycles,delay_cycles)
