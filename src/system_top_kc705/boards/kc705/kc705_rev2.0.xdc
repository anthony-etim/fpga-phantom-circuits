...
set_property LOC SLICE_X122Y3 [get_cells {simple_transmitter_INST/txWireStart}]
set_property BEL A6LUT [get_cells {simple_transmitter_INST/txWireEnd}]
# set_property LOC SLICE_X144Y83 [get_cells {simple_transmitter_INST/txWireEnd}]
set_property LOC SLICE_X122Y83 [get_cells {simple_transmitter_INST/txWireEnd}]
set_property LOCK_PINS {I0:A2} [get_cells {simple_transmitter_INST/txWireEnd}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {simple_transmitter_INST/tx_wire}]
# receiver RO 1
set_property BEL D6LUT [get_cells {phantum_DUT/ro_INST/ro_stages[0].ro_buf}]
set_property LOC SLICE_X122Y4 [get_cells {phantum_DUT/ro_INST/ro_stages[0].ro_buf}]
set_property BEL A6LUT [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
# set_property LOC SLICE_X144Y84 [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property LOC SLICE_X122Y84 [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property LOCK_PINS {I0:A2} [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {phantum_DUT/ro_INST/ro_wire[2]}]
# transmitter tx 2
set_property BEL D6LUT [get_cells {simple_transmitter_INST/txWireStart_second}]
set_property LOC SLICE_X122Y5 [get_cells {simple_transmitter_INST/txWireStart_second}]
set_property BEL A6LUT [get_cells {simple_transmitter_INST/txWireEnd_second}]
# set_property LOC SLICE_X144Y85 [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property LOC SLICE_X122Y85 [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property LOCK_PINS {I0:A2} [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {simple_transmitter_INST/tx_wire_second}]
...
resize_pblock [get_pblocks Pblock_phantom] -add {SLICE_X0Y0:SLICE_X79Y139}
...
resize_pblock [get_pblocks Pblock_ro_heater_sensor_zero] -add {SLICE_X1Y299:SLICE_X7Y299}
...
# resize_pblock [get_pblocks Pblock_ro_heater_sensor_one] -add {CLOCKREGION_X0Y4:CLOCKREGION_X0Y4}
resize_pblock [get_pblocks Pblock_ro_heater_sensor_one] -add {SLICE_X0Y249:SLICE_X7Y249}
...
# resize_pblock [get_pblocks Pblock_ro_heater_sensor_one] -add {CLOCKREGION_X0Y4:CLOCKREGION_X0Y4}
resize_pblock [get_pblocks Pblock_ro_heater_sensor_two] -add {SLICE_X0Y199:SLICE_X7Y199}
...
# resize_pblock [get_pblocks Pblock_ro_heater_sensor_one] -add {CLOCKREGION_X0Y4:CLOCKREGION_X0Y4}
resize_pblock [get_pblocks Pblock_ro_heater_sensor_three] -add {SLICE_X0Y149:SLICE_X7Y149}
...
# resize_pblock [get_pblocks Pblock_ro_clock] -add {SLICE_X84Y149:SLICE_X87Y149} // original
resize_pblock [get_pblocks Pblock_ro_clock] -add {SLICE_X84Y199:SLICE_X87Y199}
