...
def writeXDC(constraints, fileName="kc705_rev2.0.xdc"):
...
def gen_ac701(xdcfile):
    signal_name_width = [("reset_sw", 1),\
                        ...
                        #  ("fifo_data_rd[4]", 32),\
                         ...
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[0].state", 2),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[1].state", 2),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[2].state", 2),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[3].state", 2),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[0].ro_counter_reset", 1),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[1].ro_counter_reset", 1),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[2].ro_counter_reset", 1),\
                         ("phantum_DUT/GEN_RO_COUNTER_FSM[3].ro_counter_reset", 1),\
                        #  ("phantum_DUT/fifo_full", 4),\
                        #  ("phantum_DUT/GEN_RO_COUNTER_FSM[0].fifo_wr_en", 1),\
                        #  ("phantum_DUT/GEN_RO_COUNTER_FSM[1].fifo_wr_en", 1),\
                        #  ("phantum_DUT/GEN_RO_COUNTER_FSM[2].fifo_wr_en", 1),\
                        #  ("phantum_DUT/GEN_RO_COUNTER_FSM[3].fifo_wr_en", 1),\
                        #  ("phantum_DUT/GEN_RO_COUNTER_FSM[0].fifo_data_wr", 32),\
    ...
    writeXDC(constraints, fileName=xdcfile)


def gen_kc705(xdcfile):
    signal_name_width = [("reset_sw", 1),\
                         ("start_phantum", 1),\
                        ]
    
    # constraints =read_xdc_lib("clock.xdc") + read_xdc_lib("longwires_artyA7.xdc") + ILASetup(signal_name_width, 200_000_000)
    constraints =read_xdc_lib("clock_kc705.xdc") + read_xdc_lib("longwires_kc705.xdc")
    writeXDC(constraints, fileName=xdcfile)
