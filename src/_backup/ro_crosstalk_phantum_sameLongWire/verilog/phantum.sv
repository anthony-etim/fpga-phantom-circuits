...
module phantum #(
    // parameter DELAYCYCLES = 5_000_000,// to be changed in top module
    parameter NUM_RO_COUNTER = 5,// to be changed in top module
    ...
    // output wire    [31:0]     fifo_data_rd [NUM_RO_COUNTER-1:0]
...
// localparam DELAYCYCLES_UNIT = (DELAYCYCLES >> 2);
