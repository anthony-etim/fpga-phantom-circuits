...
xilinx_tools_path = "/tools/Xilinx/Vivado/2021.1/bin/"
...
cmd = "sed -ie 's/parameter CLK_SPEED     = 300_000_000,/parameter CLK_SPEED     = %d,/g' %s"%(int(input_clk_freq_mhz)*1000000, build_dir + '/src/top.sv')
