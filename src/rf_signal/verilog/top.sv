...
localparam CLK_WIZ_SPEED = 50_000_000;
...
reg             set_tdc_start       = 0;
reg             set_tdc_reset       = 0;// Active high
reg  [7:0]      tdc_data   [3:0];
wire  [31:0]    tdc_status [3:0];
reg   [3:0]     tdc_finish_out      = 0;
...
localparam HEATER_ROS     	= 500;
localparam HEATER_STAGES	= 2;

reg [7:0]  enable_ro_heater = 0;
