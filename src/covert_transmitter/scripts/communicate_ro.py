...
def vary_fpga():
    ...
    # for num_trans in range(kc705_no_trans,-1,-1):
    # for num_trans in range(ac701_no_trans,ac701_no_trans-1,-1):
    # for num_trans in range(ac701_no_trans,-1,-1):
        ...
        parameters = {
            ...
            # 'outdir': 'measurements/fpga/{}/'.format(trig_bit),
        }
        com.measure(parameters)
...
class Communicator(object):
    ...
    def __init__(self, recv_port=RECEIVER_UART_PORT , recv_serial_no=RECEIVER_SERIAL, trans_port=TRANSMITTER_UART_PORT, trans_serial_no=TRANSMITTER_SERIAL, baudrate=115200, parity=serial.PARITY_ODD):
    ...
    def upload_one(bitfile, serial=''):
        ...
        uploadfile = get_transmitter_script_dir() + 'upload.tcl'
