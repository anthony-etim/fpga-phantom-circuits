...
set_property LOC SLICE_X144Y5 [get_cells {simple_transmitter_INST/txWireStart}]
set_property BEL A6LUT [get_cells {simple_transmitter_INST/txWireEnd}]
set_property LOC SLICE_X144Y73 [get_cells {simple_transmitter_INST/txWireEnd}]
set_property LOCK_PINS {I0:A2} [get_cells {simple_transmitter_INST/txWireEnd}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {simple_transmitter_INST/tx_wire}]
# receiver RO 1
set_property BEL D6LUT [get_cells {phantum_DUT/ro_INST/ro_stages[0].ro_buf}]
set_property LOC SLICE_X144Y6 [get_cells {phantum_DUT/ro_INST/ro_stages[0].ro_buf}]
set_property BEL A6LUT [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property LOC SLICE_X144Y74 [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property LOCK_PINS {I0:A2} [get_cells {phantum_DUT/ro_INST/ro_stages[1].ro_buf}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {phantum_DUT/ro_INST/ro_wire[2]}]
# transmitter tx 2
set_property BEL D6LUT [get_cells {simple_transmitter_INST/txWireStart_second}]
set_property LOC SLICE_X144Y7 [get_cells {simple_transmitter_INST/txWireStart_second}]
set_property BEL A6LUT [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property LOC SLICE_X144Y75 [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property LOCK_PINS {I0:A2} [get_cells {simple_transmitter_INST/txWireEnd_second}]
set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 LVB_L0 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {simple_transmitter_INST/tx_wire_second}]
