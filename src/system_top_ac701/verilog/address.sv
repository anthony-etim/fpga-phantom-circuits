...
`define SET_NUM_TX_BITS                     8'b0100_0101
`define SET_COOLDOWN_CYCLES                 8'b0100_0110

// Ro heater functions
`define SET_RO_HEATER_START                 8'b0100_0111
`define SET_RO_HEATER_CYCLES                8'b0100_1000
`define SET_RO_SENSOR_CYCLES                8'b0100_1001
`define SET_RO_SENSOR_CYCLES_OFFSET         8'b0100_1010
`define SET_RO_HEATER_DATA                  8'b0100_1011
`define SET_RO_HEATER_DATA_LEN              8'b0100_1100
`define SET_RO_HEATER_ON_NUM                8'b0100_1101
...
`define GET_RO_HEATER_FIFO_ADDR_0           8'b0110_0101
`define GET_RO_HEATER_FIFO_ADDR_1           8'b0110_0110
`define GET_RO_HEATER_FIFO_ADDR_2           8'b0110_0111
`define GET_RO_HEATER_FIFO_ADDR_3           8'b0110_1000


// RO CLOCK test
`define GET_RO_COUNTS                       8'b0111_0000
`define GET_MMCM_COUNTS                     8'b0111_0001
`define GET_MMCM_LOCKED_STATUS              8'b0111_0010
`define GET_PHAN_START                      8'b0111_0011

// Intial and final ro measure
`define SET_INITIAL_MEASURE                 8'b0111_0100
`define SET_FINAL_MEASURE                   8'b0111_0101

`define GET_DEBUG_DATA_0                    8'b1000_0000
`define GET_DEBUG_DATA_1                    8'b1000_0001
// steps to add a channel in UART
// 1. add address here
// 2. add state in top.sv 
