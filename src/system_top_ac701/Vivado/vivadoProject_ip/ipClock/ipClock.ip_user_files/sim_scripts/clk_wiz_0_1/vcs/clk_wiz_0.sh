...
#
# Generated by Vivado on Thu Apr 14 14:56:32 EDT 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../ipClock.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../ipClock.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/shanquan/git/fpga-phantom-circuits/src/ro_crosstalk_phantum_sameLongWire/Vivado/vivadoProject_ip/ipClock/ipClock.cache/compile_simlib/vcs"
  fi
