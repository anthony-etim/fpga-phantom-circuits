...
--               /home/anthony/Documents/fpga-phantom-circuits/src/system_top_ac701/ip/xc7a200tfbg676/clk_wiz_ro_clock/clk_wiz_ro_clock_sim_netlist.vhdl
...
entity clk_wiz_ro_clockclk_wiz_ro_clock_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_wiz_ro_clockclk_wiz_ro_clock_clk_wiz : entity is "clk_wiz_ro_clock_clk_wiz";
end clk_wiz_ro_clockclk_wiz_ro_clock_clk_wiz;

architecture STRUCTURE of clk_wiz_ro_clockclk_wiz_ro_clock_clk_wiz is
  signal clk_in1_clk_wiz_ro_clock : STD_LOGIC;
  signal clk_out1_clk_wiz_ro_clock : STD_LOGIC;
  signal clk_out1_clk_wiz_ro_clock_en_clk : STD_LOGIC;
  signal clkfbout_buf_clk_wiz_ro_clock : STD_LOGIC;
  signal clkfbout_clk_wiz_ro_clock : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_clk_wiz_ro_clock,
      O => clkfbout_buf_clk_wiz_ro_clock
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_clk_wiz_ro_clock,
      O => clk_out1_clk_wiz_ro_clock_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      BANDWIDTH => "HIGH",
      CLKFBOUT_MULT_F => 5.875000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => false,
      CLKIN1_PERIOD => 2.304000,
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_clk_wiz_ro_clock,
      CLKFBOUT => clkfbout_clk_wiz_ro_clock,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_clk_wiz_ro_clock,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_clk_wiz_ro_clock,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_clk_wiz_ro_clock_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
entity clk_wiz_ro_clock is
  ...
  attribute NotValidForBitStream of clk_wiz_ro_clock : entity is true;
end clk_wiz_ro_clock;

architecture STRUCTURE of clk_wiz_ro_clock is
begin
inst: entity work.clk_wiz_ro_clockclk_wiz_ro_clock_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
