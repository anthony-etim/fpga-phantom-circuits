...
(* DEBUG_TX_WIRE = "5'b10010" *) (* ECO_CHECKSUM = "f683add8" *) (* FINISH = "5'b00111" *) 
...
module transmitter
  ...
  (* DONT_TOUCH *) wire tx_wire_end_second;
  (* DONT_TOUCH *) wire tx_wire_second;
  ...
  LUT2 #(
    .INIT(4'h8)) 
    tx_wire_debug_INST_0
       (.I0(tx_wire_end),
        .I1(tx_wire_end_second),
        .O(tx_wire_debug));
  (* SOFT_HLUTNM = "soft_lutpair1" *) 
  LUT5 #(
    .INIT(32'h88888B88)) 
