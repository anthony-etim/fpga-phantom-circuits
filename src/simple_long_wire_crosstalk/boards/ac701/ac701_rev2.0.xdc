...
# set_property BEL D6LUT [get_cells {transmitter_INST/txWireStart_second}]
# set_property LOC SLICE_X144Y3 [get_cells {transmitter_INST/txWireStart_second}]
# set_property BEL A6LUT [get_cells {transmitter_INST/txWireEnd_second}]
# set_property LOC SLICE_X144Y35 [get_cells {transmitter_INST/txWireEnd_second}]
# set_property LOCK_PINS {I0:A2} [get_cells {transmitter_INST/txWireEnd_second}]
# set_property FIXED_ROUTE {CLBLM_M_D CLBLM_LOGIC_OUTS15 NR1BEG3 LVB_L0 LVB_L0 NN6BEG2 NL1BEG1 IMUX_L2 CLBLM_M_A2} [get_nets {transmitter_INST/tx_wire_second}]
