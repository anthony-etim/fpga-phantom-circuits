...
def tdc_xdc (tdc_inst_hier, tdc_loc, pblock_name, tdc_id = 0, tdc_xdc_lib="./ac701/tdc_carry4_X12Y150_org.xdc" ):
...
def gen_ac701(xdcfile, n = 1, places = [[12, 150]]):
    ...
    constraints = constraints + read_xdc_lib("./ac701/ro_heater_org.xdc")
