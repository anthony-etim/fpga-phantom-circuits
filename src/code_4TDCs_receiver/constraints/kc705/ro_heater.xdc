...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets -hierarchical -filter {NAME =~ RO_GEATER_GEN[*].heater_inst/*}]

# RO heater
create_pblock Pblock_ro_heater
# resize_pblock [get_pblocks Pblock_ro_heater] -add {SLICE_X50Y90:SLICE_X110Y140}
resize_pblock [get_pblocks Pblock_ro_heater] -add {SLICE_X30Y220:SLICE_X70Y300}
# resize_pblock [get_pblocks Pblock_ro_heater] -add {SLICE_X24Y220:SLICE_X79Y349}
