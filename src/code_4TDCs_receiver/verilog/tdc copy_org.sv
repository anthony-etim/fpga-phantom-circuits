...
reg [31:0] tdc_initial_delay_counter = 0;
reg [31:0] tdc_intermediate_delay_counter = 0;
reg [31:0] TDC_INTERMEDIATE_DELAY_CYCLES = (local_stressor_count_cycles >> ($clog2(MEASUREMENTS_PER_CYCLES))); 
reg [31:0] TDC_INITIAL_DELAY_CYCLES = (TDC_INTERMEDIATE_DELAY_CYCLES >> 1); // measure in the middle
reg [31:0] TDC_TOTAL_MEASUREMENTS  = (measurement_num  << $clog2(MEASUREMENTS_PER_CYCLES));
reg [31:0] measCount = 0;
reg [31:0] measCount_prev = 0;
...
////////////////////////////////////
reg [31:0] average_counter = 0;
reg [31:0] average_reg = 0;
reg average_reg_reset = 0;
reg [CMPTDCFIFO_WIDTH-1:0] average_result = 0;
reg average_done = 0;
