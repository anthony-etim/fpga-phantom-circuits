...
def phantum_experiment(usb_port, baud, delayCycles, tx_delayTime, tx=None):
    ...
    # save data to file
    dFileName = "data_rep%d_%s"%(num_rep, timeStamp())
...
if __name__ == "__main__":
    ...
    phantum_experiment(usb_port, args.baud, delayCycles= 2**23, tx_delayTime= int((2**23)*10), tx=args.bit)
